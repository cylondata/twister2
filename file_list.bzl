def get_list():
    ...
    bin_files_darwin = ["bin/opal_wrapper",
                              "bin/mpiexec",
                              "bin/ompi-dvm",
                              "bin/orted",
                              "bin/mpirun",
    ...
    include_files_darwin = ["include/mpif-ext.h",
                                  "include/openmpi/ompi/mpiext/affinity/c/mpiext_affinity_c.h",
                                  "include/openmpi/ompi/mpiext/cuda/c/mpiext_cuda_c.h",
                                  "include/openmpi/ompi/mpi/java/mpiJava.h",
                                  "include/mpif-c-constants-decl.h",
    ...
    lib_files_darwin = ["lib/libmca_common_monitoring.50.dylib",
    ...
    if ("@bazel_tools//src/conditions:darwin"):
        return bin_files_darwin + etc_files_darwin + include_files_darwin + lib_files_darwin
    else:
        return bin_files + etc_files + include_files + lib_files