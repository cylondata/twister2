...
# example: 
# docker build -t twister2/standalone:0.4.0 .
```
...
Docker image contains the source code and prebuilt twister2. Prebuilt twister2 is in the `~/twister2-0.4.0`  So, make sure that you are in that directory
