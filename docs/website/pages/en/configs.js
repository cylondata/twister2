...
<table><thead><tr><td width="25%">Name</td><td width="25%">Default</td><td width="50%">Description</td></tr></thead><tbody><tr><td>twister2.data.hadoop.home</td><td>${'{HADOOP_HOME}'}</td><td></td></tr><tr><td>twister2.data.hdfs.url</td><td>hdfs://hostname.domain.name:9000</td><td></td></tr><tr><td>twister2.data.hdfs.class</td><td>org.apache.hadoop.hdfs.DistributedFileSystem</td><td></td></tr><tr><td>twister2.data.hdfs.implementation.key</td><td>fs.hdfs.impl</td><td></td></tr><tr><td>twister2.data.hdfs.config.directory</td><td>${'{HADOOP_HOME}'}/etc/hadoop/core-site.xml</td><td></td></tr><tr><td>twister2.data.hdfs.data.directory</td><td>${'{HADOOP_HOME}'}/etc/hadoop/hdfs-site.xml</td><td></td></tr><tr><td>twister2.data.hdfs.namenode</td><td>hostname.domain.name</td><td></td></tr><tr><td>twister2.data.hdfs.namenode.port</td><td>9000</td><td></td></tr><tr><td>twister2.data.fs.root</td><td>${'{TWISTER2_HOME}'}/persistent/data</td><td></td></tr><tr><td>twister2.data.hdfs.root</td><td>/twister2/persistent/data</td><td></td></tr></tbody></table>
...
<table><thead><tr><td width="25%">Name</td><td width="25%">Default</td><td width="50%">Description</td></tr></thead><tbody><tr><td>twister2.resource.zookeeper.server.addresses</td><td>149.165.150.81:2181</td><td><hr/><b>Options</b><ul><li>127.0.0.1:3000,127.0.0.1:3001,127.0.0.1:3002</li></ul></td></tr><tr><td>#twister2.zookeeper.root.node.path</td><td>/twister2</td><td>the root node path of this job on ZooKeeper<br/>the default is "/twister2"</td></tr></tbody></table>
...
<table><thead><tr><td width="25%">Name</td><td width="25%">Default</td><td width="50%">Description</td></tr></thead><tbody><tr><td>kubernetes.image.pull.policy</td><td>Always</td><td>image pull policy, by default is IfNotPresent<br/>it could also be Always</td></tr></tbody></table>
...
<h3>ZooKeeper related config parameters</h3>
<table><thead><tr><td width="25%">Name</td><td width="25%">Default</td><td width="50%">Description</td></tr></thead><tbody><tr><td>twister2.zookeeper.based.group.management</td><td>false</td><td>ZooKeeper can be used to exchange job status data and discovery<br/>Workers can discover one another through ZooKeeper<br/>They update their status on ZooKeeper<br/>Dashboard can get job events through ZooKeeper<br/>If fault tolerance is enabled, ZooKeeper is used, irrespective of this parameter</td></tr><tr><td>twister2.resource.zookeeper.server.addresses</td><td>ip:port</td><td><hr/><b>Options</b><ul><li>127.0.0.1:3000,127.0.0.1:3001,127.0.0.1:3002</li></ul></td></tr><tr><td>twister2.zookeeper.root.node.path</td><td>/twister2</td><td>the root node path of this job on ZooKeeper<br/>the default is "/twister2"</td></tr></tbody></table>

<h3>Uploader Settings in Kubernetes<br/>When a job is submitted, the job package needs to be transferred to worker pods<br/>Two upload methods are provided:<br/>  a) Job Package Transfer Using kubectl file copy (default)<br/>  b) Job Package Transfer Through a Web Server<br/>Following two configuration parameters control the uploading with the first method<br/>when the submitting client uploads the job package directly to pods using kubectl copy</h3>
<table><thead><tr><td width="25%">Name</td><td width="25%">Default</td><td width="50%">Description</td></tr></thead><tbody><tr><td>twister2.resource.kubernetes.client.to.pods.uploading</td><td>true</td><td>if the value of this parameter is true,<br/>the job package is transferred from submitting client to pods directly<br/>if it is false, the job package will be transferred to pods through the upload web server<br/>default value is true</td></tr><tr><td>twister2.resource.kubernetes.uploader.watch.pods.starting</td><td>true</td><td>When the job package is transferred from submitting client to pods directly,<br/>upload attempts can either start after watching pods or immediately when StatefulSets are created<br/>watching pods before starting file upload attempts is more accurate<br/>it may be slightly slower to transfer the job package by watching pods though<br/>default value is true</td></tr></tbody></table>

<h3>Following configuration parameters sets up the upload web server,<br/>when the job package is transferred through a webserver<br/>Workers download the job package from this web server</h3>
<table><thead><tr><td width="25%">Name</td><td width="25%">Default</td><td width="50%">Description</td></tr></thead><tbody><tr><td>twister2.resource.uploader.directory</td><td>/absolute/path/to/uploder/directory/</td><td>the directory where the job package file will be uploaded,<br/>make sure the user has the necessary permissions to upload the file there.<br/>full directory path to upload the job package with scp</td></tr><tr><td>twister2.uploader.directory.repository</td><td>/absolute/path/to/uploder/directory/</td><td></td></tr><tr><td>twister2.resource.download.directory</td><td>http://webserver.address:port/download/dir/path</td><td>web server link of the job package download directory<br/>this is the same directory as the uploader directory</td></tr><tr><td>twister2.resource.uploader.scp.command.options</td><td>--chmod=+rwx</td><td>This is the scp command options that will be used by the uploader, this can be used to<br/>specify custom options such as the location of ssh keys.</td></tr><tr><td>twister2.resource.uploader.scp.command.connection</td><td>user@uploadserver.address</td><td>The scp connection string sets the remote user name and host used by the uploader.</td></tr><tr><td>twister2.resource.uploader.ssh.command.options</td><td></td><td>The ssh command options that will be used when connecting to the uploading host to execute<br/>command such as delete files, make directories.</td></tr><tr><td>twister2.resource.uploader.ssh.command.connection</td><td>user@uploadserver.address</td><td>The ssh connection string sets the remote user name and host used by the uploader.</td></tr><tr><td>twister2.resource.class.uploader</td><td>edu.iu.dsc.tws.rsched.uploaders.scp.ScpUploader</td><td>the uploader class<hr/><b>Options</b><ul><li>edu.iu.dsc.tws.rsched.uploaders.NullUploader</li><li>edu.iu.dsc.tws.rsched.uploaders.localfs.LocalFileSystemUploader</li></ul></td></tr><tr><td>twister2.resource.uploader.download.method</td><td>HTTP</td><td>this is the method that workers use to download the core and job packages<br/>it could be  HTTP, HDFS, ..</td></tr></tbody></table>

<h3>Node locations related settings<br/>If this parameter is set as true,<br/>Twister2 will use the below lists for node locations:<br/>  kubernetes.datacenters.list<br/>  kubernetes.racks.list<br/>Otherwise, it will try to get these information by querying Kubernetes Master<br/>It will use below two labels when querying node locations<br/>For this to work, submitting client has to have admin privileges</h3>
<table><thead><tr><td width="25%">Name</td><td width="25%">Default</td><td width="50%">Description</td></tr></thead><tbody><tr><td>twister2.resource.rack.labey.key</td><td>rack</td><td>rack label key for Kubernetes nodes in a cluster<br/>each rack should have a unique label<br/>all nodes in a rack should share this label<br/>Twister2 workers can be scheduled by using these label values<br/>Better data locality can be achieved<br/>no default value is specified</td></tr><tr><td>twister2.resource.datacenter.labey.key</td><td>datacenter</td><td>data center label key<br/>each data center should have a unique label<br/>all nodes in a data center should share this label<br/>Twister2 workers can be scheduled by using these label values<br/>Better data locality can be achieved<br/>no default value is specified</td></tr><tr><td>  - echo</td><td>['blue-rack', 'green-rack']</td><td>Data center list with rack names</td></tr><tr><td>  - green-rack</td><td>['node11.ip', 'node12.ip', 'node13.ip']</td><td>Rack list with node IPs in them</td></tr></tbody></table>
