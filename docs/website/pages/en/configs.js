...
<table><thead><tr><td width="25%">Name</td><td width="25%">Default</td><td width="50%">Description</td></tr></thead><tbody><tr><td>twister2.data.hadoop.home</td><td>${'{HADOOP_HOME}'}</td><td></td></tr><tr><td>twister2.data.hdfs.config.directory</td><td>${'{HADOOP_HOME}'}/etc/hadoop/core-site.xml</td><td></td></tr><tr><td>twister2.data.hdfs.data.directory</td><td>${'{HADOOP_HOME}'}/etc/hadoop/hdfs-site.xml</td><td></td></tr><tr><td>twister2.data.hdfs.namenode</td><td>Kannan-Govindarajans-MacBook-Pro.local</td><td></td></tr><tr><td>twister2.data.hdfs.namenode.port</td><td>9000</td><td></td></tr><tr><td>twister2.data.fs.root</td><td>${'{TWISTER2_HOME}'}/persistent/data</td><td></td></tr><tr><td>twister2.data.hdfs.root</td><td>/twister2/persistent/data</td><td></td></tr></tbody></table>
...
<h3>ZooKeeper related config parameters</h3>
<table><thead><tr><td width="25%">Name</td><td width="25%">Default</td><td width="50%">Description</td></tr></thead><tbody><tr><td>twister2.zookeeper.based.group.management</td><td>false</td><td>ZooKeeper can be used to exchange job status data and discovery<br/>Workers can discover one another through ZooKeeper<br/>They update their status on ZooKeeper<br/>Dashboard can get job events through ZooKeeper<br/>If fault tolerance is enabled, ZooKeeper is used, irrespective of this parameter</td></tr><tr><td>twister2.resource.zookeeper.server.addresses</td><td>ip:port</td><td>when conf/kubernetes/deployment/zookeeper-wo-persistence.yaml is used<br/>following service name can be used as zk address<hr/><b>Options</b><ul><li>127.0.0.1:3000,127.0.0.1:3001,127.0.0.1:3002</li><li>twister2-zookeeper.default.svc.cluster.local:2181</li></ul></td></tr><tr><td>twister2.zookeeper.root.node.path</td><td>/twister2</td><td>the root node path of this job on ZooKeeper<br/>the default is "/twister2"</td></tr></tbody></table>
