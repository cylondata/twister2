...
<table><tr><td>default</td><td>11111</td><tr><td>description</td><td><br/>twister2 job master port number<br/>default value is 11111</td></table>
...
<table><tr><td>default</td><td>1.0</td><tr><td>description</td><td><br/>twister2 job master volatile volume size in GB<br/>default value is 1.0 Gi<br/>if this value is 0, volatile volume is not setup for job master</td></table>

**twister2.job.master.persistent.volume.size**
<table><tr><td>default</td><td>1.0</td><tr><td>description</td><td><br/>twister2 job master persistent volume size in GB<br/>default value is 1.0 Gi<br/>if this value is 0, persistent volume is not setup for job master</td></table>
...
<table><tr><td>default</td><td>1000</td><tr><td>description</td><td><br/>twister2 job master RAM request in MB<br/>default value is 0.2 percentage</td></table>

**twister2.job.master.ip**
<table><tr><td>default</td><td>"127.0.0.1"</td><tr><td>description</td><td><br/>the job master ip to be used, this is used only in client based masters</td></table>
