#! /bin/sh
###############################################################################################
# This script is used to start sshd server for password free ssh access between pods
# This script is downloaded from:
# https://raw.githubusercontent.com/everpeace/kube-openmpi/master/image/rootfs/start_sshd.sh
###############################################################################################
