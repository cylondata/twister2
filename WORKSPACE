...
maven_jar(
    ...
    artifact = "io.kubernetes:client-java:3.0.0",
)

maven_jar(
    name = "io_kubernetes_client_java_api",
    artifact = "io.kubernetes:client-java-api:3.0.0",
)

maven_jar(
    name = "io_kubernetes_client_java_proto",
    artifact = "io.kubernetes:client-java-proto:3.0.0",
)
