...
public final class WorkerParameter {
  private static final Logger LOG = Logger.getLogger(WorkerParameter.class.getName());
   ...
   */
  public static WorkerParameter build(Config cfg) {
