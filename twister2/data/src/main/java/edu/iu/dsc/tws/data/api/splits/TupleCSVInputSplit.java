...
public class TupleCSVInputSplit extends DelimitedInputSplit<String> {

  private static final Logger LOG = Logger.getLogger(TupleCSVInputSplit.class.getName());
  /**
   ...
   */
  public TupleCSVInputSplit(int num, Path file, long start, long length, String[] hosts) {
  ...
  public String readRecord(String reusable, byte[] bytes, int readOffset, int numBytes)
    ...
    LOG.info("I am getting called inside the read record method");
