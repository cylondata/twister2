...
public class Twister2ArrowFileWriter implements ITwister2ArrowFileWriter {
  ...
  public Twister2ArrowFileWriter(String arrowfile, boolean flag, Schema schema, int workerid) {
    ...
    LOG.info("arrow file:" + this.arrowFile);
  }
  ...
  public boolean setUpTwister2ArrowWrite() throws Exception {
  ...
  public void writeArrowData(Integer integerdata) throws Exception {
    ...
    LOG.info("integer data:" + integerdata);
