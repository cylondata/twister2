...
public abstract class CompleteCSVInputPartitioner<OT>
  ...
  public CompleteCSVInputPartitioner(Path filePath, Config cfg) {
    this.filePath = filePath;
    this.config = cfg;
  }

  public CompleteCSVInputPartitioner(Path filePath, Config cfg, int datasize) {
    this.filePath = filePath;
    this.config = cfg;
