...
public class LocalCompleteTextInputPartitioner extends CompleteFileInputPartitioner<String> {
  ...
  public LocalCompleteTextInputPartitioner(Path filePath, int numTasks) {
    super(filePath);
    this.nTasks = numTasks;
  }

  public LocalCompleteTextInputPartitioner(Path filePath, int numTasks, Config config) {
