...
public class RowSinkOp<T> extends BaseOp implements ICompute<T>, Closable, Collector {
  ...
  public RowSinkOp(SinkFunc<T> sink, BaseTSet originTSet, Map<String, String> receivableTSets) {
