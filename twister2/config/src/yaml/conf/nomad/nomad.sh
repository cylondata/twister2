...
#wget http://149.165.150.81:8082/twister2/mesos/twister2-core-0.5.0.tar.gz .
...
if [ $method = "LOCAL" ]; then
  ...
  cp $11/twister2-core-0.5.0.tar.gz .
else
  wget $8 .
  wget $9 .
fi

tar -xvf twister2-core-0.5.0.tar.gz
