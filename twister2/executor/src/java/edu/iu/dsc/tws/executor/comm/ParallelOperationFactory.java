...
import edu.iu.dsc.tws.executor.comm.batch.AllReduceBatchOperation;
import edu.iu.dsc.tws.executor.comm.batch.BroadcastBatchOperation;
import edu.iu.dsc.tws.executor.comm.batch.GatherBatchOperation;
import edu.iu.dsc.tws.executor.comm.batch.KeyedReduceBatchOperation;
import edu.iu.dsc.tws.executor.comm.batch.PartitionBatchOperation;
import edu.iu.dsc.tws.executor.comm.batch.PartitionByMultiByteBatchOperation;
import edu.iu.dsc.tws.executor.comm.batch.ReduceBatchOperation;
import edu.iu.dsc.tws.executor.comm.streaming.AllReduceStreamingOperation;
import edu.iu.dsc.tws.executor.comm.streaming.BroadcastStreamingOperation;
import edu.iu.dsc.tws.executor.comm.streaming.GatherStreamingOperation;
import edu.iu.dsc.tws.executor.comm.streaming.KeyedReduceStreamingOperation;
import edu.iu.dsc.tws.executor.comm.streaming.PartitionByMultiByteStreamingOperation;
