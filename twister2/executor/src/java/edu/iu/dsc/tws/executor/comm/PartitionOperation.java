...
public class PartitionOperation {
  ...
  public void prepare(Set<Integer> srcs, Set<Integer> dests, int edge,
    ...
    op.init(config, Utils.dataTypeToMessageType(dataType), taskPlan, edge);
  }

  public static class PartitionReceiver implements MessageReceiver {
    @Override
