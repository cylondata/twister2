...
public class NumpyHolderBuilder implements Serializable {
  ...
  public static NumpyHolderBuilder getInstance() {
    return INSTANCE;
  }

  public NumpyHolder build(Object numpyBinary, Object type, Object shape) {
    return new NumpyHolder(numpyBinary, type, shape);
  }
}
