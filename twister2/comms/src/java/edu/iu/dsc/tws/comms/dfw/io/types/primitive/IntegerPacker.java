...
public final class IntegerPacker implements PrimitivePacker<Integer> {
  ...
  @Override
  public MessageType<Integer> getMessageType() {
    return MessageType.INTEGER;
  }

  @Override
  public BiFunction<ByteBuffer, Integer, ByteBuffer> getByteBufferAppendFunction() {
    return ByteBuffer::putInt;
  }

  @Override
  public BiFunction<ByteBuffer, Integer, Integer> getByteBufferReadFunction() {
