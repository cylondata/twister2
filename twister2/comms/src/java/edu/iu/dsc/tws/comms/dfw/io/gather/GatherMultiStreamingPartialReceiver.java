...
public class GatherMultiStreamingPartialReceiver implements MultiMessageReceiver {
  private Map<Integer, KGatherStreamingPartialReceiver> receiverMap = new HashMap<>();

  public GatherMultiStreamingPartialReceiver() {
  }
  ...
  public void init(Config cfg, DataFlowOperation op,
    ...
    for (Map.Entry<Integer, Map<Integer, List<Integer>>> e : expectedIds.entrySet()) {
      KGatherStreamingPartialReceiver partialReceiver = new KGatherStreamingPartialReceiver(
          e.getKey(), 10, 1);
  ...
  public boolean onMessage(int source, int path, int target, int flags, Object object) {
    KGatherStreamingPartialReceiver partialReceiver = receiverMap.get(path);
  ...
  public boolean progress() {
    ...
    for (Map.Entry<Integer, KGatherStreamingPartialReceiver> e : receiverMap.entrySet()) {
