...
public class ShortKeyPacker implements KeyPacker {
  @Override
  ...
  public boolean writeKeyToBuffer(Object key,
    ...
    return KeySerializer.copyKeyToBuffer(key, MessageType.SHORT, targetBuffer,
        state, null);
  }
  ...
  public int readKeyFromBuffer(InMessage currentMessage, int currentLocation,
    ...
    return PartialKeyDeSerializer.readFromBuffer(currentMessage, MessageType.SHORT,
        currentLocation, buffer, currentObjectLength, null);
  }

  @Override
  public Object initializeUnPackKeyObject(int size) {
    return PartialKeyDeSerializer.createKeyObject(MessageType.SHORT, size);
  }
