...
public class DoubleKeyPacker implements KeyPacker {
  @Override
  ...
  public boolean writeKeyToBuffer(Object key,
    ...
    return KeySerializer.copyKeyToBuffer(key, MessageType.DOUBLE, targetBuffer,
        state, null);
  }
  ...
  public Object initializeUnPackKeyObject(int size) {
    return PartialKeyDeSerializer.createKeyObject(MessageType.DOUBLE, size);
  }
