...
public class AllGatherBatchFinalReceiver extends GatherBatchFinalReceiver {
  private MPIDataFlowBroadcast reduceReceiver;

  private MPIDataFlowBroadcast broadcast;

  public AllGatherBatchFinalReceiver(GatherBatchReceiver gatherBatchReceiver,
                                     MPIDataFlowBroadcast bcast) {
    super(gatherBatchReceiver);
