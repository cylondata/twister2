...
public class KeyedReduceStreamingPartialReceiver extends KeyedReduceStreamingReceiver {
  private static final Logger LOG = Logger.getLogger(
      KeyedReduceStreamingPartialReceiver.class.getName());

  public KeyedReduceStreamingPartialReceiver(int dst, ReduceFunction function) {
    super(dst, function);
