...
public abstract class KeyedReduceStreamingReceiver implements MessageReceiver {
  private static final Logger LOG = Logger.getLogger(KeyedReduceStreamingReceiver.class.getName());
  ...
  public KeyedReduceStreamingReceiver(ReduceFunction function) {
    this(0, function);
  }

  public KeyedReduceStreamingReceiver(int dst, ReduceFunction function) {
