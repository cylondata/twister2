...
public class DataFlowDirect implements DataFlowOperation, ChannelReceiver {
   ...
   * Initialize
   */
  private void init(Config cfg, MessageType t, TaskPlan taskPlan, int edge) {
    ...
    Set<Integer> sources = new HashSet<>(sourceId);
