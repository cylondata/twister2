...
public class LongKeyPacker implements KeyPacker {
  @Override
  ...
  public boolean writeKeyToBuffer(Object key,
    ...
    return KeySerializer.copyKeyToBuffer(key, MessageType.LONG, targetBuffer,
        state, null);
  }
  ...
  public Object initializeUnPackKeyObject(int size) {
    return PartialKeyDeSerializer.createKeyObject(MessageType.LONG, size);
  }
