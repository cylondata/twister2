...
public class HeapTest {
  ...
  public void insert() {
    ...
    heap.insert(new Tuple<>(15, 15), 1);
    heap.insert(new Tuple<>(6, 6), 1);
    heap.insert(new Tuple<>(17, 17), 1);
    heap.insert(new Tuple<>(7, 7), 1);
    heap.insert(new Tuple<>(10, 10), 1);
    heap.insert(new Tuple<>(12, 12), 1);
    heap.insert(new Tuple<>(5, 5), 1);
