...
public final class FileConstants {
  ...
  public static String getLoggerContent() {
    return "handlers="
        + "edu.iu.dsc.tws.common.logging.Twister2FileLogHandler, java.util.logging.ConsoleHandler\n"
        + ".level=INFO\n"
        ...
        + "edu.iu.dsc.tws.common.logging.Twister2LogFormatter\n"
        ...
        + "edu.iu.dsc.tws.rsched.utils.JobUtils.formatter="
        + "edu.iu.dsc.tws.common.logging.Twister2LogFormatter";
  }
}
