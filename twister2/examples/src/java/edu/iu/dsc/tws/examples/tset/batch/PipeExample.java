...
public class PipeExample extends BatchTsetExample {
  private static final Logger LOG = Logger.getLogger(PipeExample.class.getName());
  ...
  public static void main(String[] args) {
    ...
    BatchTsetExample.submitJob(config, PARALLELISM, jobConfig, PipeExample.class.getName());
  }
}
