...
public class TestingWorkerMain {

  private static final Logger LOG = Logger.getLogger(TestingWorkerMain.class.getName());
  ...
  public static void main(String[] args) throws ParseException {
    ...
    jobBuilder.setJobName("Testing-job");
    jobBuilder.setWorkerClass(TestingWorker.class.getName());
