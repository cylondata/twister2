...
public class IterativePredictionDataStreamer1 extends BaseSource implements IReceptor<Double> {
  private static final long serialVersionUID = -5619263102396811849L;

  private static final Logger LOG = Logger.getLogger(IterativePredictionDataStreamer1.class
      .getName());
  ...
  public IterativePredictionDataStreamer1(OperationMode operationMode) {
    this.operationMode = operationMode;
  }

  public IterativePredictionDataStreamer1(int features, OperationMode operationMode,
