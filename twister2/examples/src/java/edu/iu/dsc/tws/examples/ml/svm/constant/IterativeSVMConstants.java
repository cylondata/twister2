...
public final class IterativeSVMConstants {

  private IterativeSVMConstants() {
  }

  public static final String TRAINING_DATA_LOADING_TASK_GRAPH = "training-data-loading-task-graph";
