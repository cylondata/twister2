...
public class IterativeDataStream1 extends BaseSource implements IReceptor<double[][]> {
  private static final Logger LOG = Logger.getLogger(IterativeDataStream1.class.getName());
  ...
  public IterativeDataStream1(OperationMode operationMode) {
    this.operationMode = operationMode;
  }

  public IterativeDataStream1(int features, OperationMode operationMode) {
    this.features = features;
    this.operationMode = operationMode;
  }

  public IterativeDataStream1(int features, OperationMode operationMode, boolean isDummy,
