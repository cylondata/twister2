...
import edu.iu.dsc.tws.examples.task.streaming.PartitionStreamingTask;
...
public class ReduceHLBatchTask implements IContainer {
  @Override
  ...
  public static void main(String[] args) {
    ...
    jobBuilder.setContainerClass(PartitionStreamingTask.class.getName());
