...
package edu.iu.dsc.tws.examples.basic.timely;
...
public class SimpleTaskStats implements IContainer {

  private static final Logger LOG = Logger.getLogger(SimpleTaskStats.class.getName());
...
//              + " count: " + sendCount++);
  ...
  public static void main(String[] args) {
    ...
    BasicJob basicJob = BasicJob.newBuilder()
        .setName("basic-simple-task-stats")
        .setContainerClass(SimpleTaskStats.class.getName())
