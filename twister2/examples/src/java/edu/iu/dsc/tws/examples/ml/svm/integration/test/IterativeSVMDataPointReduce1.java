...
public class IterativeSVMDataPointReduce1 extends BaseSink<double[][]>
    implements ICollector<double[][]> {

  private static final long serialVersionUID = 5737384175970887837L;
  private static final Logger LOG = Logger.getLogger(IterativeSVMDataPointReduce1.class.getName());
  ...
  public IterativeSVMDataPointReduce1(OperationMode operationMode) {
