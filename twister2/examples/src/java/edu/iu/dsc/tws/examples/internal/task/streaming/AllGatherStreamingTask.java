...
public class AllGatherStreamingTask implements IWorker {
  ...
  private static class GeneratorTask extends BaseStreamSource {
    ...
    @Override
    public void execute() {
      boolean wrote = context.write("all-gather-edge", "Hello");
      if (wrote) {
        count++;
        if (count % 1000 == 0) {
  ...
  public static void main(String[] args) {
    ...
    jobBuilder.setWorkerClass(AllGatherStreamingTask.class.getName());
