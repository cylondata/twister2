 ...
 * of objects.
 */
public class TestingDataObjectCompute extends BaseCompute {

  private static final Logger LOG = Logger.getLogger(TestingDataObjectCompute.class.getName());
  ...
  public TestingDataObjectCompute(String edgename, int dsize, int parallel, int dim) {
  ...
  public TestingDataObjectCompute(String edgename, int size, int dim) {
    this.edgeName = edgename;
    this.datasize = size;
    this.dimension = dim;
  }
