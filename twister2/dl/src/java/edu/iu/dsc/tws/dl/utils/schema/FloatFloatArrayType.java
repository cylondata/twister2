...
public class FloatFloatArrayType implements MessageType<FloatFloatArrayPair, float[]> {
  @Override
  ...
  @Override
  public int getDataSizeInBytes(FloatFloatArrayPair data) {
  ...
  public Class getClazz() {
    return FloatFloatArrayPair.class;
  }

  @Override
  public DataPacker getDataPacker() {
    return FloatFloatArrayPacker.getInstance();
  }
