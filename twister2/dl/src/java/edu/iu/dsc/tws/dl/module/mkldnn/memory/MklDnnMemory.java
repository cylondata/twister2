...
public class MklDnnMemory {

  public static long MemoryDescInit(int ndims, int[] dims, int dataType, int dataFormat, MemoryOwner owner){
  ...
  public static long EltwiseBackwardDescInit(int algKind, long diffDataDesc, long dataDesc, float alpha,
                                      float beta, MemoryOwner owner){
    return new MklMemoryDescInit(
        MklDnn.EltwiseBackwardDescInit(algKind, diffDataDesc, dataDesc, alpha, beta), owner).getPtr();
  }

  public static long LinearForwardDescInit(int propKind, long srcMemDesc, long weightMemDesc,
                                    long biasMemDesc, long dstMemDesc, MemoryOwner owner){
    return new MklMemoryDescInit(
        MklDnn.LinearForwardDescInit(propKind, srcMemDesc, weightMemDesc, biasMemDesc, dstMemDesc), owner).getPtr();
  }

  public static long LinearBackwardDataDescInit(long diffSrcMemDesc, long weightMemDesc, long diffDstMemDesc, MemoryOwner owner){
    return new MklMemoryDescInit(
        MklDnn.LinearBackwardDataDescInit(diffSrcMemDesc, weightMemDesc, diffDstMemDesc), owner).getPtr();
  }

  public static long LinearBackwardWeightsDescInit(long srcMemDesc, long diffWeightMemDesc,
                                            long diffBiasMemDesc, long diffDstMemDesc, MemoryOwner owner){
    return new MklMemoryDescInit(
        MklDnn.LinearBackwardWeightsDescInit(srcMemDesc,
            diffWeightMemDesc, diffBiasMemDesc, diffDstMemDesc), owner).getPtr();
  }

  public static long BatchNormForwardDescInit(int propKind, long srcMemDesc, float epsilon, long flags, MemoryOwner owner){
    return new MklMemoryDescInit(
  ...
  public static long BatchNormBackwardDescInit(int prop_kind, long diffDstMemDesc, long srcMemDesc,
    ...
    return new MklMemoryDescInit(
        MklDnn.BatchNormBackwardDescInit(prop_kind, diffDstMemDesc, srcMemDesc, epsilon, flags), owner).getPtr();
  }

  public static long SoftMaxForwardDescInit(int prop_kind, long dataDesc, int axis, MemoryOwner owner){
    return new MklMemoryDescInit(
  ...
  public static long SoftMaxBackwardDescInit(int propKind, long diffDesc, long dstDesc,
    ...
    return new MklMemoryDescInit(MklDnn.SoftMaxBackwardDescInit(diffDesc, dstDesc, axis), owner).getPtr();
  }

  public static long ConvForwardDescInit(int prop_kind, int alg_kind, long src_desc, long weights_desc,
  ...
  public static long DilatedConvForwardDescInit(int prop_kind, int alg_kind, long src_desc,
                                         long weights_desc, long bias_desc, long dst_desc, int[] strides,
                                         int[] dilates, int[] padding_l, int[] padding_r, int padding_kind, MemoryOwner owner){
    return new MklMemoryDescInit(
  ...
  public static long ConvBackwardWeightsDescInit(int alg_kind, long src_desc, long diff_weights_desc,
  ...
  public static long DilatedConvBackwardWeightsDescInit(int alg_kind, long src_desc, long diff_weights_desc,
                                                 long diff_bias_desc, long diff_dst_desc, int[] strides, int[] dilates,
                                                 int[] padding_l, int[] padding_r, int padding_kind, MemoryOwner owner){
    return new MklMemoryDescInit(
  ...
  public static long ConvBackwardDataDescInit(int alg_kind, long diff_src_desc, long weights_desc,
                                       long diff_dst_desc, int[] strides, int[] padding_l, int[] padding_r,
  ...
  public static long DilatedConvBackwardDataDescInit(int alg_kind, long diff_src_desc, long weights_desc,
                                              long diff_dst_desc, int[] strides, int[] padding_l, int[] dilates,
                                              int[] padding_r, int padding_kind, MemoryOwner owner){
    return new MklMemoryDescInit(
  ...
  public static long PoolingForwardDescInit(int prop_kind, int alg_kind, long src_desc, long dst_desc,
                                     int[] strides, int[] kernel, int[] padding_l, int[] padding_r,
                                     int padding_kind, MemoryOwner owner){
    return new MklMemoryDescInit(
  ...
  public static long LRNBackwardDescInit(int alg_kind, long diff_data_desc, long data_desc, int local_size,
                                  float alpha, float beta, float k, MemoryOwner owner){
    return new MklMemoryDescInit(
  ...
  public static long RNNCellDescInit(int kind,int f, int flags, float alpha, float clipping, MemoryOwner owner){
    return new MklMemoryDescInit(
  ...
  public static long RNNForwardDescInit(int prop_kind, long rnn_cell_desc, int direction,
                                 long src_layer_desc, long src_iter_desc, long weights_layer_desc, long weights_iter_desc,
                                 long bias_desc, long dst_layer_desc, long dst_iter_desc, MemoryOwner owner){
    return new MklMemoryDescInit(
  ...
  public static long RNNBackwardDescInit(int prop_kind, long rnn_cell_desc, int direction,
                                  long src_layer_desc, long src_iter_desc, long weights_layer_desc, long weights_iter_desc,
                                  long bias_desc, long dst_layer_desc, long dst_iter_desc, long diff_src_layer_desc,
                                  long diff_src_iter_desc, long diff_weights_layer_desc, long diff_weights_iter_desc,
                                  long diff_bias_desc, long  diff_dst_layer_desc, long diff_dst_iter_desc, MemoryOwner owner){
    return new MklMemoryDescInit(
  ...
  public static long ReorderPrimitiveDescCreateV2(long input, long output, long attr, MemoryOwner owner){
    return new MklMemoryPrimitiveDesc(
  ...
  public static long PrimitiveDescCreate(long opDesc, long engine, long hingForwardPrimitiveDesc, MemoryOwner owner){
    return new MklMemoryPrimitiveDesc(MklDnn.PrimitiveDescCreate(opDesc, engine, hingForwardPrimitiveDesc), owner).getPtr();
  }
  ...
  public static long ViewPrimitiveDescCreate(long memory_primitive_desc, int[] dims, int[] offsets, MemoryOwner owner){
    return new MklMemoryPrimitiveDesc(
