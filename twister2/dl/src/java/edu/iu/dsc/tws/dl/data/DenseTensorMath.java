...
public class DenseTensorMath {
  ...
  public static Tensor add(double s, DenseTensor t) {
    ...
    result.resizeAs(t);
    result.copy(t);
    TensorFunc2 func = (data, index) -> data[index] = TensorNumeric.plus(data[index], s);
  ...
  public static Tensor sub(double s, DenseTensor t) {
    ...
    result.resizeAs(t);
    result.copy(t);
    TensorFunc2 func = (data, index) -> data[index] = TensorNumeric.minus(data[index], s);
    DenseTensorApply.apply1(result, func);
    return result;
  }
  ...
  public static Tensor neg(DenseTensor self) {
    ...
    TensorFunc2 func = (data, index) -> data[index] = TensorNumeric.negative(data[index]);
    DenseTensorApply.apply1(result, func);
    return result;
  }
  ...
  public static Tensor divide(double s, DenseTensor t) {
    ...
    result.resizeAs(t);
    result.copy(t);
    TensorFunc2 func = (data, index) -> data[index] = TensorNumeric.divide(data[index], s);
    DenseTensorApply.apply1(result, func);
    return result;
  }
  ...
  public static Tensor mul(double s, DenseTensor t) {
    ...
    result.resizeAs(t);
    result.copy(t);
    TensorFunc2 func = (data, index) -> data[index] = TensorNumeric.times(data[index], s);
    DenseTensorApply.apply1(result, func);
    return result;
  }
  ...
  public static Tensor mul(Tensor self, Tensor t) {
    if (self.nDimension() == 1 && t.nDimension() == 1) {
      ...
      Tensor result = new DenseTensor(t.size(2), self.size(1)).t();
  ...
  public static double prodAll(DenseTensor self) {
    ...
    TensorFunc2 func = (data, index) -> product[0] = TensorNumeric.times(data[index], product[0]);
    DenseTensorApply.apply1(self, func);
    return product[0];
  }
  ...
  public static double sumAll(DenseTensor self) {
    ...
    TensorFunc2 func = (data, index) -> sum[0] = TensorNumeric.plus(data[index], sum[0]);
    DenseTensorApply.apply1(self, func);
    return sum[0];
  }
  ...
  public static Tensor prod(DenseTensor self, Tensor x, int _dim) {
    ...
    DenseTensor result = (self == null) ? new DenseTensor() : self;
    int[] sizes = x.size();
    sizes[_dim] = 1;
    result.resize(sizes);
    throw new UnsupportedOperationException("operation not supported");
  ...
  public static Tensor addmm(Tensor r, double beta, Tensor t,
    ...
    if (r.stride(1) == 1 && r.stride(2) != 0) {
      ...
      transpose_r = 'n';
      _r = new DenseTensor(r.size(2), r.size(1));
      _r.copy(r);
      _r = _r.transpose(1, 2);
    }
  ...
  public static double meanAll(DenseTensor self) {
    ...
    TensorFunc2 func = (data, index) -> sum[0] = TensorNumeric.plus(data[index], sum[0]);
    DenseTensorApply.apply1(self, func);
    return TensorNumeric.divide(sum[0], (double) self.nElement());
  }
