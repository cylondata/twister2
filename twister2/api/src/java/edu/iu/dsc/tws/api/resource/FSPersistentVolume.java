 ...
 */
public class FSPersistentVolume implements IPersistentVolume {
  ...
  public FSPersistentVolume(String jobDirPath, int workerID) {
    ...
    workerDirPath = jobDirPath + File.separator + WORKER_DIR_NAME_PREFIX + workerID;
    logDirPath = jobDirPath + LOG_DIR_NAME;
    logFileName = logDirPath + File.separator + WORKER_LOG_FILE_NAME_PREFIX + workerID + ".log";
    createLogDir();
  }
