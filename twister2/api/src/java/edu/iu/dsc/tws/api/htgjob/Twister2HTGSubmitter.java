...
//   */
//  public static void submitHTGJob(Twister2HTGJob twister2HTGJob, Config config) {
//
...
//    JobAPI.HTGJob htgJob = twister2HTGJob.serialize();
//    //JobAPI.Job job = twister2Job.serialize();
//
//    JobAPI.Job job = null;
//    Config updatedConfig = null;
//
//    if (htgJob instanceof JobAPI.HTGJob) {
//      job = htgJob.getJob();
//      updatedConfig = JobUtils.updateConfigs(job, config);
//    }
//
//    // launch the launcher
...
//
//        LOG.info("****************** JobName modified. Following jobname will be used: "
// + jobName);
//      }
//    }
//
