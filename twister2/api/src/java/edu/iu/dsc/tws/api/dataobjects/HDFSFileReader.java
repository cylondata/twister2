...
public class HDFSFileReader {
  ...
  public HDFSFileReader(Config cfg) {
    this.config = cfg;
  }
  ...
  public double[][] readDataPoints(String fName, int dimension, String filesystem) {
    ...
    BufferedReader bufferedReader = DataObjectUtils.getBufferedReader(config, fName, filesystem);
    try {
      int value = 0;
      String line;
  ...
  public double[][] readCentroids(String fName, int dimension, int numberOfClusters,
    ...
    BufferedReader bufferedReader = DataObjectUtils.getBufferedReader(config, fName, filesys);
    try {
      int value = 0;
      String line;
      while ((line = bufferedReader.readLine()) != null) {
