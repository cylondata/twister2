...
public class SMapTSet<T, P> extends SBaseTSet<P> {

  private MapFunc<T, P> mapFn;

  public SMapTSet(TSetEnvironment tSetEnv, MapFunc<T, P> mapFunc, int parallelism) {
...
//    return true;
  ...
  @Override
  public SMapTSet<T, P> setName(String n) {
    rename(n);
    return this;
  }
}
