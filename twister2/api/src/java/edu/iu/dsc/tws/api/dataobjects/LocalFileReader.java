...
public class LocalFileReader {
  ...
  public double[][] readDataPoints(String fName, int dimension, String filesystem) {
    ...
    BufferedReader bufferedReader = DataObjectUtils.getBufferedReader(null, fName, filesystem);
    int lengthOfFile = DataObjectUtils.getNumberOfLines(fName);
  ...
  public double[][] readCentroids(String fileName, int dimension, int numberOfClusters,
    ...
    BufferedReader bufferedReader = DataObjectUtils.getBufferedReader(null, fileName, filesystem);
    try {
      int value = 0;
      String line;
      while ((line = bufferedReader.readLine()) != null) {
