...
import graphbuilder.DirectedTaskGraph;
import graphbuilder.TaskGraph;
...
public class Main {
    ...
    public static void main(String[] args){
        ...
        DirectedTaskGraph<Mapper, CManager> taskVertices = new DefaultDirectedTaskGraph<Mapper, CManager> (CManager.class);
